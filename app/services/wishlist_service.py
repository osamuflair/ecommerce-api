...
def remove_from_wishlist(db: Session, wishlist_item_id: int) -> WishlistItem:
    existing_wishlist_item = db.query(WishlistItem).filter(WishlistItem.id == wishlist_item_id).first()
